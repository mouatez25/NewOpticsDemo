...
namespace GestionClinique.Patient
{
    public partial class WindowLevelGraphControl : UserControl
    {
        ...
        GestionClinique.Patient.Dicom.ImageBitsPerPixel iBpp;
        bool signedImage;
        ...
        public void SetWindowWidthCentre(int minVal, int maxVal, int widthVal, int centreVal,
            GestionClinique.Patient.Dicom.ImageBitsPerPixel bpp, bool sign)
        {
            winMin = minVal;
            winMax = maxVal;
            winWidth = widthVal;
        ...
        void DrawLines(Graphics g)
        {
            ...
            if (iBpp == GestionClinique.Patient.Dicom.ImageBitsPerPixel.Eight || iBpp == GestionClinique.Patient.Dicom.ImageBitsPerPixel.TwentyFour)
            {
